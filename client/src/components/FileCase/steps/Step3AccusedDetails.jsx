  ...
  return (
    <div className="space-y-6">
      <h2 className="text-xl font-semibold text-gray-800">
        Step 3: Accused Person(s) Details
      </h2>
      <p className="text-sm text-gray-500">
        List all known individuals responsible for the offense. If unknown,
        leave blank.
      </p>
      ...
      <button
        ...
        className="py-2 px-4 text-sm bg-gray-100 text-gray-700 font-semibold rounded-lg hover:bg-gray-200"
      >
        + Add Another Accused
      </button>
